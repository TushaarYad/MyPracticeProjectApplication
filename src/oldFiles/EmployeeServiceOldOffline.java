...
*/
@Service
public class EmployeeServiceOldOffline {
    ...
    public EmployeeServiceOldOffline(EmployeeRepo empRepo, PasswordEncoder passwordEncoder){
    ...
    public EmployeeGETResponse saveEmployeeService(EmployeePOSTRequest emp){
        ...
        return EmployeeGETResponse.from( empRepo.saveEmployeeRepo(buildEmployee(newId, encodedPassword, emp)));
    ...
    public EmployeeGETResponse updateEmployeeService(int id, EmployeePOSTRequest emp){
        ...
        return  EmployeeGETResponse.from( empRepo.saveEmployeeRepo(buildEmployee(id, password, emp)));
    }
