...
public class EmployeeRepo {
    ...
    //Check if the id is present inside the HashMap
    public boolean checkExistEmpById(Integer id){
    ...
    public List<Employee> searchEmpRepo(String name, String type) {
        return employees.values()
                ...
                .filter(e -> type == null || e.getClass().getSimpleName().toLowerCase().contains(type.toLowerCase()))
                .toList();
    }
